...
const BioData = () => {
  return (
    <>
      {" "}
      <Navbar />
      <div className="m-8 border p-4 h-auto w-auto bg-gray-100">
        ...
        <p className="text-justify font-sans ">
          ...
          Engineering, equipping me with the skills and knowledge needed to
          pursue my professional aspirations. Whether it's through
          problem-solving, collaboration, or innovation, I'm excited to
          contribute to projects that align with my values and ambitions.
        </p>
      </div>
    </>
  );
